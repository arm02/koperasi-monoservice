...
<div class="box-body">
<p></p>
<p style="text-align:center; font-size: 15pt; font-weight: bold;"> RINCIAN SHU BERDASARKAN JASA  PINJAMAN </p>
...
<table  class="table table-bordered">
	<tr class="header_kolom">
		...
		<th style="width:15%; vertical-align: middle; text-align:center" colspan="4"> Jasa Pinjaman </th>
		<th style="width:15%; vertical-align: middle; text-align:center" rowspan="2"> SHU </th>
	</tr>
	<tr class="header_kolom">
...
function doSearch() {
	...
	$('#fmCari').attr('action', '<?php echo site_url('lapb_keuangan_shu_pinjaman'); ?>');
	$('#fmCari').submit();	
}
