...
<div class="box box-solid box-primary">
	<div class="box-header">
		<h3 class="box-title">Rekapitulasi Tagihan Pinjaman Berjangka Pokok</h3>
...
title="Rekapitulasi Tagihan Pinjaman Berjangka Pokok"
style="width:auto; height: auto;"
url="<?php echo site_url('lapb_koperasi_tagihan_berjangka/ajax_list'); ?>"
...
function clearSearch(){
	window.location.href = '<?php echo site_url("lapb_koperasi_tagihan_berjangka"); ?>';
}
...
function cetak () {
	var tahun = $('#tahun_cari').val();
	if(tahun){
		var win = window.open('<?php echo site_url("lapb_koperasi_tagihan_berjangka/cetak?tahun=' + tahun +'"); ?>');
	}else{
		var win = window.open('<?php echo site_url("lapb_koperasi_tagihan_berjangka/cetak"); ?>');
	}
	if (win) {
		win.focus();
	} else {
