...
<div class="box box-solid box-primary">
	<div class="box-header">
		<h3 class="box-title">Cetak Data Tagihan Berjangka</h3>
...
<div class="box-body">
<p></p>
<p style="text-align:center; font-size: 15pt; font-weight: bold;"> Rekapitulasi Tagihan Pinjaman Berjangka Pokok </p>
...
function doSearch() {
	...
	$('#fmCari').attr('action', '<?php echo site_url('lapb_koperasi_tagihan_berjangka'); ?>');
	$('#fmCari').submit();	
}
