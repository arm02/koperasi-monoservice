...
<div class="box box-solid box-primary">
	<div class="box-header">
		<h3 class="box-title">Data Rekap Jasa Berjangka</h3>
...
title="Data Rekap Jasa Berjangka"
style="width:auto; height: auto;"
url="<?php echo site_url('lapb_koperasi_rekap_jasa_berjangka/ajax_list'); ?>"
...
function clearSearch(){
	window.location.href = '<?php echo site_url("lapb_koperasi_rekap_jasa_berjangka"); ?>';
}
...
function cetak () {
	...
	if($('#reportrange').text() != 'Tanggal'){
		var win = window.open('<?php echo site_url("lapb_koperasi_rekap_jasa_berjangka/cetak?tgl_dari=' + tgl_dari + '&tgl_samp=' + tgl_samp + '"); ?>');
	}else{
		var win = window.open('<?php echo site_url("lapb_koperasi_rekap_jasa_berjangka/cetak"); ?>');
	}
	if (win) {
		win.focus();
	} else {
