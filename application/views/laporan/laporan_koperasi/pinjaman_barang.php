...
<div class="box-body">
<p></p>
<p style="text-align:center; font-size: 15pt; font-weight: bold;"> Rekapitulasi Pinjaman Barang </p>
...
function doSearch() {
	...
	$('#fmCari').attr('action', '<?php echo site_url('lapb_koperasi_pinjaman_barang'); ?>');
	$('#fmCari').submit();	
}

function cetak () {
	var tahun = $('input[name=tahun]').val();
	var win = window.open('<?php echo site_url("lapb_koperasi_pinjaman_barang/cetak/?tahun=' + tahun +'"); ?>');
	if (win) {
		win.focus();
	} else {
