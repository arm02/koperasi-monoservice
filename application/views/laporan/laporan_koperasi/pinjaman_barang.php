...
<div class="box box-solid box-primary">
	<div class="box-header">
		<h3 class="box-title">Cetak Data Pinjaman Barang</h3>
...
title="Data Pinjaman Barang"
style="width:auto; height: auto;"
url="<?php echo site_url('lapb_koperasi_pinjaman_barang/ajax_list'); ?>"
...
function clearSearch(){
	window.location.href = '<?php echo site_url("lapb_koperasi_pinjaman_barang"); ?>';
}
...
function cetak () {
	...
	if($('#reportrange').text() != 'Tanggal'){
		var win = window.open('<?php echo site_url("lapb_koperasi_pinjaman_barang/cetak?tgl_dari=' + tgl_dari + '&tgl_samp=' + tgl_samp + '"); ?>');
	}else{
		var win = window.open('<?php echo site_url("lapb_koperasi_pinjaman_barang/cetak"); ?>');
	}
	if (win) {
		win.focus();
	} else {
