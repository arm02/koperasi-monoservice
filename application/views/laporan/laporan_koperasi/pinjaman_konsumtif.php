...
url="<?php echo site_url('lapb_koperasi_pinjaman_konsumtif/ajax_list'); ?>"
...
function clearSearch(){
	window.location.href = '<?php echo site_url("lapb_koperasi_pinjaman_konsumtif"); ?>';
}
...
function cetak () {
	...
	if($('#reportrange').text() != 'Tanggal'){
		var win = window.open('<?php echo site_url("lapb_koperasi_pinjaman_konsumtif/cetak?tgl_dari=' + tgl_dari + '&tgl_samp=' + tgl_samp + '"); ?>');
	}else{
		var win = window.open('<?php echo site_url("lapb_koperasi_pinjaman_konsumtif/cetak"); ?>');
	}
	if (win) {
		win.focus();
	} else {
