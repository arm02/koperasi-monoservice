...
<div class="box box-solid box-primary">
	<div class="box-header">
		<h3 class="box-title">Cetak Data Pinjaman Berjangka</h3>
...
title="Data Pinjaman Berjangka"
style="width:auto; height: auto;"
url="<?php echo site_url('lapb_koperasi_pinjaman_berjangka/ajax_list'); ?>"
...
function clearSearch(){
	window.location.href = '<?php echo site_url("lapb_koperasi_pinjaman_berjangka"); ?>';
}
...
function cetak () {
	...
	if($('#reportrange').text() != 'Tanggal'){
		var win = window.open('<?php echo site_url("lapb_koperasi_pinjaman_berjangka/cetak?tgl_dari=' + tgl_dari + '&tgl_samp=' + tgl_samp + '"); ?>');
	}else{
		var win = window.open('<?php echo site_url("lapb_koperasi_pinjaman_berjangka/cetak"); ?>');
	}
	if (win) {
		win.focus();
	} else {
