...
<div class="box box-primary">
  ...
  $jml_anggota_usaha = $out['dana_anggota_atas_usaha'] * $shu_stl_pajak / 100;
  $jml_anggota_modal = $out['dana_anggota_atas_modal'] * $shu_stl_pajak / 100;
  $jml_dn_pengurus = $out['dana_pengurus'] * $shu_stl_pajak / 100;
  $jml_dn_kesejahteraan_karyawan = $out['dana_kesejahteraan_karyawan'] * $shu_stl_pajak / 100;
  $jml_dn_pembangunan_daerah_kerja = $out['dana_pembangunan_daerah_kerja'] * $shu_stl_pajak / 100;
  ...
  ?>
      ...
      <tr>
        <td>Dana Anggota Atas Usaha Koperasi</td>
				<td class="h_kanan"><?php echo $out['dana_anggota_atas_usaha'] ?> % </td>
				<td class="h_kanan"> <?php echo number_format($jml_anggota_usaha) ?></td>
      </tr>
      <tr>
        <td>Dana Anggota Atas Modal Koperasi</td>
				<td class="h_kanan"><?php echo $out['dana_anggota_atas_modal'] ?> % </td>
				<td class="h_kanan"> <?php echo number_format($jml_anggota_modal) ?></td>
      </tr>
			<!-- <tr>
				<td>Jasa Anggota</td>
      ...
      <tr>
				...
				<td class="h_kanan"><?php echo $out['dana_kesejahteraan_karyawan'] ?> %</td>
				<td class="h_kanan"><?php echo number_format($jml_dn_kesejahteraan_karyawan) ?></td>
			</tr>
			<!-- <tr>
				<td>Dana Karyawan</td>
      ...
      <tr>
				...
				<td class="h_kanan"><?php echo $out['dana_pembangunan_daerah_kerja'] ?> %</td>
				<td class="h_kanan"><?php echo number_format($jml_dn_pembangunan_daerah_kerja) ?></td>
			</tr>
			<tr>
