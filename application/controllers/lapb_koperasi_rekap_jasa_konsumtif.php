...
class Lapb_koperasi_rekap_jasa_konsumtif extends OperatorController {
	...
	public function index() {
		...
		$config = array();
		$config["base_url"] = base_url() . "lapb_koperasi_rekap_jasa_konsumtif/index/halaman";
	...
	function cetak() {
		...
		'.$pdf->nsi_box($text = '<span class="txt_judul">Rekapitulasi Jasa Pinjaman Konsumtif Tahun Buku '.$_REQUEST['tahun'].' </span>', $width = '100%', $spacing = '1', $padding = '1', $border = '0', $align = 'center').'';
