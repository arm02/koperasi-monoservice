...
class Lapb_keuangan_rekap_sukarela extends OperatorController {
	...
	public function index() {
		...
		$config = array();
		$config["base_url"] = base_url() . "lapb_keuangan_rekap_sukarela/index/halaman";
		...
		$datas = $this->lap_simpanan_m->lap_koperasi_pinjaman_barang(1,10);
		print_r($datas);
	...
	function cetak() {
		...
		'.$pdf->nsi_box($text = '<span class="txt_judul">Rekapitulasi Simpanan Sukarela Koperasi Tahun '.$_REQUEST['tahun'].' </span>', $width = '100%', $spacing = '1', $padding = '1', $border = '0', $align = 'center').'';
