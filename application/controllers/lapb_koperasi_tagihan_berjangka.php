...
class Lapb_koperasi_tagihan_berjangka extends OperatorController {
	...
	public function index() {
		...
		$config = array();
		$config["base_url"] = base_url() . "lapb_koperasi_tagihan_berjangka/index/halaman";
	...
	function cetak() {
		...
		'.$pdf->nsi_box($text = '<span class="txt_judul">Rekapitulasi Tagihan Pinjaman Berjangka Pokok Tahun Buku '.$_REQUEST['tahun'].' </span>', $width = '100%', $spacing = '1', $padding = '1', $border = '0', $align = 'center').'';
