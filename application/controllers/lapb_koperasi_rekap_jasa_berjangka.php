...
class Lapb_koperasi_rekap_jasa_berjangka extends OperatorController {
	...
	public function index() {
		...
		$this->data['judul_sub'] = 'Rekap Jasa Berjangka';
		...
		$config = array();
		$config["base_url"] = base_url() . "lapb_koperasi_rekap_jasa_berjangka/index/halaman";
		...
		$this->data['isi'] = $this->load->view('laporan/laporan_koperasi/rekap_jasa_berjangka', $this->data, TRUE);
	...
	function cetak() {
		...
		'.$pdf->nsi_box($text = '<span class="txt_judul">Rekapitulasi Jasa Pinjaman Berjangka Tahun Buku '.$_REQUEST['tahun'].' </span>', $width = '100%', $spacing = '1', $padding = '1', $border = '0', $align = 'center').'';
