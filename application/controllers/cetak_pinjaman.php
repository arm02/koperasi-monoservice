...
class Cetak_pinjaman extends OperatorController {
	...
	function cetak($id) {
		...
		<br> Pada Tanggal '.jin_date_ina(date('Y-m-d')).' untuk realisasi kredit sebesar Rp. '.number_format($row->jumlah).' ('.$this->terbilang->eja(nsi_round($row->jumlah)).' RUPIAH) dengan rincian :
		<br>
		<table width="100%">   
			<tr>
