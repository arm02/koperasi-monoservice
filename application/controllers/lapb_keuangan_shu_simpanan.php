...
class Lapb_keuangan_shu_simpanan extends OperatorController {
	...
	public function index() {
		...
		$config = array();
		$config["base_url"] = base_url() . "lapb_keuangan_shu_simpanan/index/halaman";
	...
	function cetak() {
		...
		'.$pdf->nsi_box($text = '<span class="txt_judul">Rekapitulasi SHU Berdasarkan Simpanan Tahun Buku '.$_REQUEST['tahun'].' </span>', $width = '100%', $spacing = '1', $padding = '1', $border = '0', $align = 'center').'';
